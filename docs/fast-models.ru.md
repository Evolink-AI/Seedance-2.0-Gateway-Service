# Руководство по Fast-моделям Seedance 2.0

Fast-модели Seedance 2.0 используют те же схемы входных данных, что и standard-модели, но лучше подходят для быстрых итераций.
