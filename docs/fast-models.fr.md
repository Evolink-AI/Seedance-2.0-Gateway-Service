# Guide des modèles Fast de Seedance 2.0

Les modèles Fast de Seedance 2.0 utilisent les mêmes schémas d’entrée que les modèles standard, mais conviennent mieux aux itérations rapides.
