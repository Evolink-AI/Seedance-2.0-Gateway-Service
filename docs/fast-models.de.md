# Seedance 2.0 Fast-Modelle-Leitfaden

Die Fast-Modelle von Seedance 2.0 verwenden die gleichen Eingabemuster wie die Standardmodelle, sind aber stärker auf schnelle Iterationen ausgelegt.
